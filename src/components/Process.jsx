...
export default function Process() {
  return (
    <section id="process" className="relative py-20 md:py-40 px-6 md:px-8 lg:px-16 bg-wood-surface">
      <div className="max-w-[1100px] mx-auto">
        ...
        <div className="relative">
          ...
          <div className="space-y-14 md:space-y-28">
            {steps.map((step, i) => (
              <div
                key={step.num}
                className="reveal relative grid grid-cols-[48px_1fr] md:grid-cols-[120px_1fr] gap-4 md:gap-12 items-start"
              ...
              >
                ...
                <div className="pt-1 md:pt-4">
                  ...
                  <p className="font-body text-[16px] text-wood-muted leading-[1.8] max-w-md">
                    {step.description}
                  </p>
                </div>
              </div>
        ...
        <div className="reveal stagger-6 mt-16 md:mt-24 ml-0 md:ml-[168px]">
          <div className="h-px w-16 bg-amber/30 mb-6" />
          <p className="font-body text-[16px] text-wood-muted leading-[1.7] max-w-md">
